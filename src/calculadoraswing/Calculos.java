...
public class Calculos {
    ...
    public static void main(String args[]){
        ...
        //recebe os dados fornecidos pelo form JFrame Telacalculadora.java e os parametros da string Calculadora
    }
    public String calculadora(String expressao) {
        ...
        return resultado;
        //recebe todos os parametros das strings definidas e retorna o resultado
    ...
    List<Character> listaOperadores) {
        ...
        resultado = ""+total;
        return resultado;
        //cria as variaveis para receber os valores
    }
